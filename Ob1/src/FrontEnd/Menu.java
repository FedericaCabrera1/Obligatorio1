...
public class Menu {
 ...
 /*aca llamamos al metodo epico de la clase sistema 
        ...
        while (configuracion != 'A' && configuracion != 'a' && configuracion != 'P' && configuracion != 'p') {
            System.out.println("La opción igresada no es válido, reingrese una P o una A.");
    ...
    public static boolean aprietaXparaInt(int input){
       boolean seTerminaporX = false;
       String inputString = String.valueOf(input);
       if(inputString.equalsIngoreCase("x")){
           seTerminaporX = true;
       }
       return seTerminaporX;
    }
            ...
            if (!(s.quedanDosFichas()) && s.quedanJugadasDisponibles()) {
                ...
                if (cantidadMovimientos != 4) {
                    ...
                    if(columna == -1){
                        ...
                        System.out.println("Se terminó el juego, hasta pronto!");
                        s.calcularPuntaje();
                        menuPrincipal(sistema);
                    } else{
    ...
    public static int manejarError() {
        ...
        while (!esCorrecto) {
            try {
                ...
                if((String.valueOf(opcionIngresada)).equalsIgnoreCase("x")){
                    opcionIngresada = -1;
                }else{
